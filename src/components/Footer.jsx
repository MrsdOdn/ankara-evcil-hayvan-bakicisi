...
const Footer = () => {
  ...
  const distanceThreshold = 60; // İzlerin arasındaki mesafe
  ...
  const handleMouseMove = (e) => {
    ...
    // Fare yeterince hareket ettiyse yeni pati izi ekle
    if (distance > distanceThreshold) {
      const newFootprint = {
        id: Date.now(),
        x: x,
        y: y,
        // Fare yönüne göre patiyi döndürür
        rotate: Math.atan2(dy, dx) * (180 / Math.PI) + 90,
      };
      // Son 8 izi tutar, eskileri siler
      setFootprints((prev) => [...prev.slice(-7), newFootprint]);
      lastPos.current = { x, y };
    }
  };

  // İzlerin zamanla silinmesi için temizlik mekanizması
  useEffect(() => {
        ...
        {footprints.map((print) => (
          ...
          >
            <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* Pati rengini biraz daha doygunlaştırdım (orange-500/30) */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8" id="iletisim">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h4 className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-6 border-b border-orange-500/20 pb-2 w-fit">📱 SOSYAL MEDYA</h4>
            <div className="grid grid-cols-1 gap-4">
              <SocialLink href="https://www.instagram.com/ankaracimbicici" icon="instagram" color="#E4405F" label="Instagram" />
              <SocialLink href="https://www.youtube.com/@FatihErdogan-fk4te" icon="youtube" color="#FF0000" label="YouTube" />
              <SocialLink href="https://www.facebook.com/share/1AAH98mPp2/" icon="facebook" color="#1877F2" label="Facebook" />
              <SocialLink href="https://wa.me/905435498706" icon="whatsapp" color="#25D366" label="WhatsApp" />
            </div>
          </div>

          {/* 2. Sütun: İletişim */}
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h4 className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-6 border-b border-orange-500/20 pb-2 w-fit">📞 İLETİŞİM</h4>
            <div className="space-y-4">
              <a href="tel:+905435498706" className="group flex items-center justify-center sm:justify-start gap-2">
                <div className="p-2 bg-orange-500/10 rounded-full group-hover:bg-orange-500/20 transition-colors">
                  <Phone size={18} className="text-orange-500" />
                </div>
                <span className="text-xl font-bold hover:text-orange-400 transition-colors">+90 543 549 87 06</span>
              </a>
              <a href="mailto:info@ankarapatibakim.com" className="group flex items-center justify-center sm:justify-start gap-2">
                <div className="p-2 bg-orange-500/10 rounded-full group-hover:bg-orange-500/20 transition-colors">
                  <Mail size={18} className="text-orange-500" />
                </div>
                <span className="text-base text-gray-300 hover:text-orange-400 transition-colors break-all">info@ankarapatibakim.com</span>
              </a>
            </div>
          </div>
          ...
          {/* 3. Sütun: Adres */}
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h4 className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-6 border-b border-orange-500/20 pb-2 w-fit">📍 HİZMET BÖLGEMİZ</h4>
          ...
          {/* 4. Sütun: Büyük Logo ve Motto Odaklı Kapanış */}
          <div className="flex flex-col items-center lg:items-end justify-center">
            <div className="group relative">

              {/* Parlama Efekti (Arka Plan) */}
            ...
            {/* Motto Kısmı - Büyük Başlık Olmadan Sadece Bilgi */}
...
// SocialLink bileşeni aynı kalabilir...
